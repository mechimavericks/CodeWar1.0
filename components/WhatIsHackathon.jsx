...
function WhatIsHackathon() {
  return (
    <div>
      <div className="px-4 py-16 mx-auto w-full md:px-24 lg:px-8 lg:py-20 dark:bg-gray-800 dark:text-gray-100">
        ...
        <p className="mb-6 text-lg text-center ">
          ...
          from a few hours to a few days. Participants form teams, brainstorm
          ideas, and work intensively to create prototypes or functioning
          software, hardware, or other projects. Hackathons foster creativity,
          teamwork, and rapid problem-solving skills, offering a platform for
          participants to learn, network, and showcase their talents.
        </p>
      </div>
      <section className="dark:bg-gray-800 w-full dark:text-gray-100">
        <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
          ...
          <p className="mt-4 mb-8 dark:text-gray-400 text-center">
            Here are some common questions about hackathons and their answers.
          </p>
          <div className="space-y-4">
            <details className="w-full border rounded-lg">
              ...
              <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-400">
                ...
                to collaborate intensively on software projects, typically over
                a short period of time, such as 24 to 48 hours. Participants
                work on coding, designing, and building innovative solutions to
                specific challenges or themes. At the end of the event, projects
                are usually presented and judged, with prizes awarded to the
                most successful ones.
              </p>
            </details>
            <details className="w-full border rounded-lg">
              <summary className="px-4 py-6 focus:outline-none focus-visible:ri">
                How can I participate in a hackathon?
              </summary>
              <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-400">
            ...
            <details className="w-full border rounded-lg">
              <summary className="px-4 py-6 focus:outline-none focus-visible:ri">
                Can I participate in a hackathon as an individual, or do I need
            ...
            <details className="w-full border rounded-lg">
              <summary className="px-4 py-6 focus:outline-none focus-visible:ri">
                Are there any prerequisites for participating in a hackathon?
              </summary>
              <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-400">
                Hackathons typically welcome participants with a wide range of
                skills and backgrounds. While having coding or design skills can
            ...
            <details className="w-full border rounded-lg">
              ...
              <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-400">
                Hackathon projects are typically judged based on various
            ...
            <details className="w-full border rounded-lg">
              <summary className="px-4 py-6 focus:outline-none focus-visible:ri">
                What happens to the projects after the hackathon ends?
              </summary>
              <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-400">
            ...
            <details className="w-full border rounded-lg">
              <summary className="px-4 py-6 focus:outline-none focus-visible:ri">
                How can I make the most of my hackathon experience?
              </summary>
              <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-400">
                To make the most of your hackathon experience, be proactive,
