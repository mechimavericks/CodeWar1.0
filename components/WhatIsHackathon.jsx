...
function WhatIsCodeWar() {
  return (
    <section className="min-h-screen bg-gradient-to-b from-gray-800 to-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-6 sm:mb-8 text-white">
            What is CodeWar 1.0?
          </h2>
          
          <div className="bg-gray-800/50 rounded-lg p-6 sm:p-8 backdrop-blur-sm border border-gray-700">
